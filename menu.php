<div class="container">
    ...
    <nav class="navbar navbar-expand-md px-0">
        ...
        <button class="navbar-toggler mb-1" type="button" data-bs-toggle="collapse" data-bs-target="#navbarsExampleDefault" aria-controls="#navbarsExampleDefault" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            ...
            <div class="form-inline my-2 my-lg-0 descargar-cv-contenedor">
