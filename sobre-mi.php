        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-5 col-12 mt-4">
                    ...
                    <p class="pb-sm-5">Apasionado por la tecnología y la programación. Proactivo y siempre en constante aprendizaje</p>
                    <a href="" class="btn btn-rojo">Enviar mensaje</a>

                </div>
                <div class="col-sm-3 col-12 mt-4 offset-sm-2">
                    <img src="images/mauri.jpg" alt="Mauricio Fabian Rodriguez" title="Mauricio Fabian Rodriguez" class="img-fluid img-circle">
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-12- col-sm-10 p-3">
                        ...
                        <h4>MITSOGROUP</h4>
                        <h5>2019 - presente</h5>
                        <p>Desarrollo de sitios (landings,tiendas) a medida a partir de maquetación html,css,js</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-12- col-sm-10 p-3">
                        ...
                        <h4>Kalyma</h4>
                        <h5>2021 - presente</h5>
                        <p>Desarrollo de aplicaciones y mantenimiento de proyectos previos</p>
                    </div>
                </div>
            </div>
